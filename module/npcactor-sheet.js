import QuestNPCActorSheetBase from "./svelte/QuestNPCActorSheetBase.svelte"; // import Svelte App
 ...
 * @extends {ActorSheet}
 */
export class QuestNPCActorSheet extends ActorSheet {
    app = null;
    dataStore = null;
    ...
    render(force = false, options = {}) {
        ...
        this._render(force, options)
            ...
            .then((rendered) => {
                ...
                //console.log(sheetData);
                this.app = new QuestNPCActorSheetBase({
